...
public class ConstantsView {
    ...
    public static final int TEXT_AREA_Y = 530;
    ...
    public static final String NAME_BUTTON_GO = "CONNECT OBJECT";
    public static final String NAME_BUTTON_GO_GSON = "CONNECT GSON";
    public static final int GO_X = 135;
    public static final int GO_Y = 350;
    ...
    public static final String QUESTION = "Welcome!!!";
    public static final String FONT = "Arial";
    public static final int TEXT_WINDOW_X = 117;
    public static final int TEXT_WINDOW_Y = 50;
    public static final int TEXT_SIZE_FONT = 32;
    public static final int BUTTON_HEIGHT_GO = 150;
    public static final int BUTTON_Y_TRANSLATE = 300;
    public static final int PORT = 150;
    public static final int IP = 200;
    public static final String PORT_NAME = "Enter Port";
    public static final String IP_NAME = "Enter IP";
